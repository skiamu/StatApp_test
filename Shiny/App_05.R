  ...
  mainPanel(
    tabsetPanel(
      ...
      tabPanel("Trade",                    # ----
               ...
               numericInput('v7.Trd',sort(myInd.Trd)[7],0,step = 0.1),
               numericInput('v8.Trd',sort(myInd.Trd)[8],0,step = 0.1),
               numericInput('v9.Trd',sort(myInd.Trd)[9],0,step = 0.1),
               numericInput('v10.Trd',sort(myInd.Trd)[10],0,step = 0.1),
               textOutput('pred.Trd'),
